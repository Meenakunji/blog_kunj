    ...
    >
      ...
      <Box sx={style.commentChatBox}>
        <Box sx={style.profileComment}>
          <img src="https://miro.medium.com/v2/resize:fill:40:40/0*UmaG2uRQZAa-62pz" />
          <Typography variant="h3">Farhan arshad</Typography>
        </Box>
        {/* {isContentVisible && ( */}
        <textarea
        ...
        <Box sx={style.bottomSection}>
          ...
          <Box sx={style.rightBottom}>
            ...
            <Button sx={style.respond}>Respond</Button>
          </Box>
        </Box>
      </Box>
      ...
      <Box sx={style.replySection}>
        <Box sx={style.replyLeftProfile}>
          ...
          <Box sx={style.profileReply}>
            <Typography variant="h5">Sharmila kannan</Typography>
            <Typography variant="body1">18 days ago</Typography>
          </Box>
        </Box>
      ...
      <Box sx={style.replySectionComment}>
        <Typography variant="body1">
          Also, for looping through an object, you can use a for-in loop. In
          this case, you don't transform your object into an array. Like this:
